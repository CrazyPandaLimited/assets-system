...
public class NodeManifestForVersionedResourcesCreator : Node
{
	...
	[ SerializeField ]
	private string _manifestDirectoryExport;
	[ SerializeField ]
	private bool _copyManifestExternal;
	[ SerializeField ]
	private string _resourcesPathes;
	...
	{
		var customManifest = new AssetFilesManifest();
