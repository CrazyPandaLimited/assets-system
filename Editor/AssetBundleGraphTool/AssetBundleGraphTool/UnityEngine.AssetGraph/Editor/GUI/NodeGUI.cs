...
namespace UnityEngine.AssetGraph
{
    ...
    public class NodeGUI : ScriptableObject
    {
        ...
        */
        ...
        public int WindowId
        {
            get { return m_nodeWindowId; }

            set { m_nodeWindowId = value; }
        }
        ...
        */
        ...
        {
            GUI.Window(m_nodeWindowId, m_baseRect, DrawThisNode, string.Empty, _assetGraphGuiConfig.NodeSkin.FindStyle(m_nodeSyle));
        }
        ...
        private void DrawNodeContents()
        {
            ...
            var titleHeight = style.CalcSize(new GUIContent(Name)).y + _assetGraphGuiConfig.NODE_TITLE_HEIGHT_MARGIN;
            ...
            if (m_hasErrors)
            {
                ...
                EditorGUI.LabelField(new Rect((nodeTitleRect.width - labelSize.x) / 2.0f - 28f, (nodeTitleRect.height - labelSize.y) / 2.0f - 7f, 20f, 20f), string.Empty,
                    errorStyle);
            }
            ...
            Action<Model.ConnectionPointData> drawConnectionPoint = (Model.ConnectionPointData point) =>
            {
                    ...
                    label != Model.Settings.DEFAULT_OUTPUTPOINT_LABEL)
                {
                    ...
                    var xOffset = (point.IsOutput) ? -m_baseRect.width :_assetGraphGuiConfig.INPUT_POINT_WIDTH;
                ...
                Texture2D tex = (point.IsInput) ? _assetGraphGuiConfig.InputBG : _assetGraphGuiConfig.OutputBG;
        ...
        public void UpdateNodeRect()
        {
            ...
            var titleHeight = GUI.skin.label.CalcSize(new GUIContent(Name)).y + _assetGraphGuiConfig.NODE_TITLE_HEIGHT_MARGIN;
            ...
            this.m_baseRect = new Rect(m_baseRect.x, m_baseRect.y,
                m_baseRect.width,
                _assetGraphGuiConfig.NODE_BASE_HEIGHT + titleHeight + (_assetGraphGuiConfig.FILTER_OUTPUT_SPAN * Mathf.Max(0, (nPoints - 1)))
            );

            var newWidth = Mathf.Max(_assetGraphGuiConfig.NODE_BASE_WIDTH, outputLabelWidth + inputLabelWidth + _assetGraphGuiConfig.NODE_WIDTH_MARGIN);
            newWidth = Mathf.Max(newWidth, labelWidth + _assetGraphGuiConfig.NODE_WIDTH_MARGIN);
