...
namespace UnityEngine.AssetGraph
{
    ...
    {
        [SerializeField] TreeViewState m_GraphCollectionTreeState;
        [SerializeField] TreeViewState m_GraphCollectionDetailTreeState;
        ...
        public void OnGUI(Rect pos)
        {
            ...
            var toolbarBound = new Rect(0f, 0f, m_Position.width, _assetGraphGuiConfig.TOOLBAR_HEIGHT);
        ...
        private void HandleHorizontalResize()
        {
            ...
            m_HorizontalSplitterRect.y = _assetGraphGuiConfig.TOOLBAR_HEIGHT;
            m_HorizontalSplitterRect.height = m_Position.height - _assetGraphGuiConfig.TOOLBAR_HEIGHT;
