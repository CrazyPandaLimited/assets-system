...
namespace UnityEngine.AssetGraph
{
    ...
    public class ConnectionGUI : ScriptableObject
    {
        ...
        {
            get { return m_outputPoint.NodeId; }
        }

        public string InputNodeId
        {
            get { return m_inputPoint.NodeId; }
        }

        public Model.ConnectionPointData OutputPoint
        {
            get { return m_outputPoint; }
        }

        public Model.ConnectionPointData InputPoint
        {
            get { return m_inputPoint; }
        }
        ...
        {
            get { return (Selection.activeObject == this); }
        }
        ...
        public void DrawConnection(List<NodeGUI> nodes, Dictionary<string, List<AssetReference>> assetGroups)
        {
            ...
            var pointDistanceX = _assetGraphGuiConfig.CONNECTION_CURVE_LENGTH;
            ...
            if (assetGroups != null)
            {
                try
                {
                totalAssets = assetGroups.Select(v =>
                {
                    if (v.Value == null)
                    {
                        return 0;
            ...
            if (IsSelected)
            {
                lineColor = _assetGraphGuiConfig.COLOR_ENABLED;
            }
            else
            {
                lineColor = (totalAssets > 0) ? _assetGraphGuiConfig.COLOR_CONNECTED : _assetGraphGuiConfig.COLOR_NOT_CONNECTED;
            }
