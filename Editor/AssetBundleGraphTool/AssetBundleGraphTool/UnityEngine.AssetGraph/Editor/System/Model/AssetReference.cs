...
namespace UnityEngine.AssetGraph {
	...
	public class AssetReference {
		...
		[SerializeField][JsonProperty] private Guid m_guid;
		[SerializeField][JsonProperty] private string m_assetDatabaseId;
		[SerializeField][JsonProperty] private string m_importFrom;
		[SerializeField][JsonProperty] private string m_exportTo;
		[SerializeField][JsonProperty] private string m_variantName;
