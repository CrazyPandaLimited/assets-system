...
//            }
        ...
        public class Path {
            ...
            public static string GraphWorkResultCachePath { get { return System.IO.Path.Combine(UserPreference.Preferences._cachesRootPath, "GraphsResults"); } }
            public static string BundleBuilderCachePath { get { return System.IO.Path.Combine(UserPreference.Preferences._cachesRootPath, "AssetBundles"); } }
            ...
            public static string LocalEditorPathToFullPath(string localPath)
            {
                return System.IO.Path.Combine(Application.dataPath, localPath);
            }
        }
