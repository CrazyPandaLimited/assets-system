...
namespace UnityEngine.AssetGraph
{
    public class FileUtility
    {
        ...
        private static void GetFilePathsRecursively(string localFolderPath, List<string> filePaths, bool includeHidden = false,
            bool includeMeta = !Model.Settings.IGNORE_META)
        {
        ...
        */
        ...
        public static string EnsureWorkingCacheDirExists(BuildTarget t, Model.NodeData node, string name)
        {
            var cacheDir = FileUtility.PathCombine(Model.Settings.Path.GraphWorkResultCachePath, SystemDataUtility.GetPathSafeTargetName(t), name);
