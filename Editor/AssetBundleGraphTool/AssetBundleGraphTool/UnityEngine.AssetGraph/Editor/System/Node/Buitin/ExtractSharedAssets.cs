...
namespace UnityEngine.AssetGraph
{
    ...
    public class ExtractSharedAssets : Node
    {
        ...
        private void CollectDependencies(string groupKey, string[] assetPaths, ref Dictionary<string, System.Collections.Generic.List<string>> collector)
        {
            ...
            foreach (var d in dependencies)
            {
                ...
                {
                    collector[d] = new System.Collections.Generic.List<string>();
                }
