...
namespace UnityEngine.AssetGraph
{
    ...
    public class AssetGraphBasePath : ScriptableObject
    {
        ...
        public static string BasePath
        {
            get
            {
                if (string.IsNullOrEmpty(s_basePath))
                {
                    ...
                    var convertedBaseDirPath = baseDirPath.Replace(Application.dataPath + "/", "");

                    baseDirPath = ASSETS_PATH + convertedBaseDirPath;
        ...
        public static string ToolDirName
        {
            get { return "UnityEngine.AssetGraph"; }
        }
        ...
        {
            get { return UserPreference.Preferences._cachesRootPath; }
        }

        public static string SettingFilePath
        {
            get { return System.IO.Path.Combine(BasePath, "SettingFiles"); }
        }

        public static string TemporalSettingFilePath
        {
