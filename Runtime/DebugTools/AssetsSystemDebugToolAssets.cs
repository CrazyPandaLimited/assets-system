...
public class AssetsSystemDebugToolAssets : ScriptableObject
{
    ...
    [ Header( "Play mode settings" ) ] [ Header( "Select system section" ) ] [ Space ] [ Space ]
    ...
    [ Space ] [ Space ] [ Header( "Select system buttons" ) ]
    ...
    [ Space ] [ Space ] [ Header( "System Loaders section" ) ] [ Space ] [ Header( "Foldout" ) ]
    ...
    [ Header( "Context area" ) ] public GUIStyle PlayMode_LoadersTogleButtom_Style;
    public int PlayMode_LoadersTogle_Buttom_Height;

    [ Header( "Loader area" ) ] [ Header( "Foldout" ) ]
    ...
    [ Header( "Loader body" ) ] public GUIStyle PlayMode_Loader_Buttom_BG_Style;
    ...
    [ Space ] [ Space ] [ Header( "System tasks queue section" ) ] [ Space ] [ Header( "Foldout" ) ]
